...
```{r}
 movies %>%
   filter (year == 1995)
```
There were 1,248 movies released in 1995.
...
There were 4 comedies, which were Big Fish, Forrest Gump, Homem Que Copiava, O and The Incredibles with an MPPA rating over 120  minutes, have a rating of 8.
...
The harry Potter movies included with the data are Harry Potter and the Chamber of Secrets, Harry Potter and the Prisoner of Azkaban,and Harry Potter and The Chamber of Secrets. The Prisoner of Azkaban is the highest rated. Th Sorcerers Stone received the most votes.
...
The highest budget for a movie that is animated or comedy is Wild Wild West with a budget of $170,0000,000 and 19,078 votes.
